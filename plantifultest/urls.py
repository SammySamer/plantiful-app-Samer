...
urlpatterns = [
    ...
    path('app/project_settings/<str:project_id>/',views.project_settings,name='project_settings'),
    path('app/group_settings/<str:project_id>/<str:group_id>/',views.group_settings,name='group_settings'),
    ...
    path('app/newgroup/<str:project_id>/<str:groups_num>/ajax', views.update_settings_dropdown)
]
